...
class UpdateALLChannels extends Command
{
    /**
      ...
      * @var string
      */
    protected $signature = 'channels:update-all';
     ...
     * @var string
     */
    protected $description = 'Update the beta channels from the command line';
    ...
    public function handle()
    {
        ...
        $this->info("Updating the Dev channels ");
        $this->comment('==========================================================================');
        ...
        $request = $client->request('GET', 'http://d-gp2-dynadm-1.imovetv.com/dyna_app/source');
        ...
        foreach ($data as $channel) {
            ...
            try {
                ...
                $this->info(" Channel Added: " . $channel->source_name);
                // $this->info("Dev Channels Successfully Updated @:". Carbon::now()->diffForHumans());
            } catch (\Exception $e) {
                Log::alert($e);
            }
        ...
        $this->info("Dev Channels Successfully Updated @:". Carbon::now());
        Log::info("DEV Channels Successfully Updated @:". Carbon::now());
        ...
        $this->comment('');
        $this->comment('==========================================================================');
        $this->info("QA Channels Successfully Updated @:". Carbon::now());
        $this->comment('==========================================================================');
        \Log::info("QA Channels Successfully Updated @:". Carbon::now());

        $this->comment('');
        $this->comment('==========================================================================');
        $this->info("Updating the Beta channels");
        $this->comment('==========================================================================');
...
//        $request = $client->request('GET', 'http://b-gp2-dynadm-1.imovetv.com/dyna_app/source');
        $request = $client->request('GET', 'http://b-gp2-dynadm.imovetv.com/dyna_app/source');
        $data = json_decode($request->getBody()->getContents(), false);
        $channels = [];
        $source_name = \Arr::pluck($data, 'source_name');
        $audiopid = \Arr::pluck($data, 'encoder.feed.audiopid');
        ...
        foreach ($data as $channel) {
            ...
            try {
                ...
                $this->info(" Channel Added: " . $channel->source_name);
                // $this->info("Beta Channels Successfully Updated @:". Carbon::now()->diffForHumans());
            } catch (\Exception $e) {
                Log::alert($e);
            }
        ...
        $this->info("Beta Channels Successfully Updated @: ". Carbon::now()->diffForHumans());
        Log::info("Beta Channels Successfully Updated @: ". Carbon::now());
