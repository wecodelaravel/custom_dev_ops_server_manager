...
class UpdateBetaChannels extends Command
{
    /**
      ...
      * @var string
      */
    protected $signature = 'channels:update-beta';
    ...
    public function handle()
    {
        ...
        // try {
        //      $client->request('GET', 'http://b-gp2-dynadm-1.imovetv.com/dyna_app/source')->getStatusCode();
        //     return true;
...
//        $request = $client->request('GET', 'http://b-gp2-dynadm-1.imovetv.com/dyna_app/source');
        ...
        foreach ($data as $channel) {
            ...
            try {
                ...
                $this->info("Beta Channel Added: " . $channel->source_name);
