...
class UpdateDevChannels extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'channels:update-dev';
     ...
     * @var string
     */
    protected $description = 'Update the dev channels from the command line';
    ...
    public function handle()
    {
        ...
        foreach ($data as $channel) {
            ...
            try {
                ...
                $this->info("DEV Channel Added: " . $channel->source_name);
