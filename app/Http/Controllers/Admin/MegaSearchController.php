...
{
    protected $models = [
        'Channel' => 'global.channels.title',
        'Syncserver' => 'global.syncservers.title',
        'ChannelServer' => 'global.channel-server.title',
        'AggregationServer' => 'global.aggregation-server.title',
    ];
