...
class GetBetaChannels implements ShouldQueue
{
    ...
    {
        \Log::info("I am working in the background updating the beta channels.");
...
//        $request = $client->request('GET', 'http://b-gp2-dynadm-1.imovetv.com/dyna_app/source');
        ...
        foreach ($data as $channel) {
            ...
            $newchannelid                    = $channel->source_name . ".beta";
            ...
            try {
                ...
                ->updateOrInsert(
                    ...
                    [
                        ...
                        'channelid'              => $channel->source_name . ".beta",
                        'env'                    => 'beta',
                        'source_ip'              => $imc,
                        'udp'                    => $ssm,
