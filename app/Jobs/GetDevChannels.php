...
class GetDevChannels implements ShouldQueue
{
    ...
    {
        \Log::info("I am working in the background updating the dev channels.");
        ...
        foreach ($data as $channel) {
            ...
            $newchannelid                    = $channel->source_name . ".dev";
            ...
            try {
                DB::table('channels')
                    ->updateOrInsert(
                        ...
                        [
                            ...
                            'channelid'              => $channel->source_name . ".dev",
                            'env'                    => 'dev',
                            'source_ip'              => $imc,
                            'udp'                    => $ssm,
                ...
                Log::info(" Channel Added: " . $channel->source_name);
            } catch (\Exception $e) {
                Log::alert($e);
            }
