...
class Add5d12b71794d52RelationshipsToCsiTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('csis', function(Blueprint $table) {
            if (!Schema::hasColumn('csis', 'channel_server_id')) {
                $table->integer('channel_server_id')->unsigned()->nullable()->after('id');;
                ...
                $table->integer('channel_id')->unsigned()->nullable()->after('channel_server_id');
                ...
                $table->integer('protocol_id')->unsigned()->nullable()->after('channel_id');
