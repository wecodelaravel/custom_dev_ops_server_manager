...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.hosts.store']]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::checkbox('server_exists', 1, old('server_exists', false), []) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::checkbox('caipy_is_setup', 1, old('caipy_is_setup', false), []) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::checkbox('ready_to_receive_conf', 1, old('ready_to_receive_conf', false), []) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::checkbox('configured', 1, old('configured', false), []) !!}
                    <p class="help-block"></p>
