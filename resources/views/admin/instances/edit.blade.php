...
@section('content')
    ...
    {!! Form::model($instance, ['method' => 'PUT', 'route' => ['admin.instances.update', $instance->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::number('quantity_to_create', old('quantity_to_create'), ['class' => 'form-control', 'placeholder' => 'how many to create']) !!}
