                ...
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        <tr>
                            ...
                            <td field-key='role_convention'>{{ $role_convention->role_convention }}</td>
                        </tr>
                        <tr>
                            <th>@lang('global.role-conventions.fields.role-convention-value')</th>
                            <td field-key='role_convention_value'>{{ $role_convention->role_convention_value }}</td>
                        </tr>
                    </table>
                </div>
            </div><!-- Nav tabs -->
...
{!! Form::open(array(
        ...
        @endif
            ...
            <a href="{{ route('admin.role_conventions.index') }}" class="btn btn-default">@lang('global.app_back_to_list')</a>
        </div>
    </div>
@stop
